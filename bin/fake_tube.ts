...
import {FakeTubeMonitoringStack} from "../lib/fake_tube_monitoring-stack";
...
const defaultStackSynthesizer3 = new cdk.DefaultStackSynthesizer({
  // Name of the S3 bucket for file assets
  fileAssetsBucketName:
    "cdk-${Qualifier}-assets-${AWS::AccountId}-${AWS::Region}",
  bucketPrefix: "",
...
const persistentStack = new FakeTubePersistentStack(app, 'FakeTubePersistentStackCW', {
  synthesizer: defaultStackSynthesizer2,
})

const apiStack = new FakeTubeApiStack(app, 'FakeTubeApiStackCW', {
  synthesizer: defaultStackSynthesizer,
  table: persistentStack.table,
});

new FakeTubeMonitoringStack(app, 'FakeTubeMonitoringStackCW', {
  api: apiStack.api,
  handler: apiStack.handler,
  synthesizer: defaultStackSynthesizer3,
  table: persistentStack.table,
});
